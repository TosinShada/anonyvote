...
contract Semaphore is Ownable, IncrementalQuinTree {
     ...
     */
    constructor(uint8 _treeLevels, uint232 _firstExternalNullifier, IVerifier _verifier)
     ...
     */
    function insertIdentity(uint256 _identityCommitment) public onlyOwnerIfPermissioned
    {
